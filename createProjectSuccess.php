												...
												<div class="profile-block">
													...
													<div class="confirmation-area">
														<div class="donate-holder">
															...
															<strong>Your Project Created Successfully</strong>
															<h3>Thank you so much for your Trustment</h3>
															<p>You can find your project in My Projects tag.You can also upload updates for your project.<br>Only if the project doesn't meet the min value till the deadline will it fail</p>
														</div>
													</div>
												</div>
												</div>
