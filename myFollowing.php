											...
											<div class="col-lg-12">
												<div class="profile-block">
													<ul class="scroll-nav">
															...
															<li class="active"><a href="myFollowing.php"><i class="icon-save"></i>My Following</a></li>
														</ul>
										...
										<div class="cs-members col-lg-12">
											<div class="row">
												...
												<div class="title col-lg-12">
													<h3>FOLLOWING MEMEBERS</h3>
												</div>
												<?php
												include("mysqlconnect.php");
												$getFollowUsers="select loginname,hometown,uimg from users natural join (select loginB as loginname from follow where loginA='".$_SESSION['loginname']."')as T";
												$result=mysqli_query($connection,$getFollowUsers) or die ("Couldn't execute queryInsert: " . mysqli_error());
												while($row = @mysqli_fetch_array($result,MYSQLI_ASSOC)){
													$image=$row["uimg"];
													$name=$row["loginname"];
													$hometown=$row["hometown"];

													echo "<div class=\"agentinfo-detail col-lg-12\">";
													echo "<div class=\"about-info\">";
														echo "<figure>";
															echo "<a style=\"border-radius:6px;\" href=\"#\"><img alt=\"\" src=\"$image\"></a>";
														echo "</figure>";
														echo "<div class=\"agentdetail-info\">";
															echo "<div class=\"left-info\">";
																echo "<a style=\"display:none\" href=\"javascript:void(0)\">$name</a>";
																echo "<h3>$name</h3>";
																echo "<span class=\"location\"><i class=\"cscolor icon-map-marker\"></i>$hometown</span>";
															echo "</div>";
															echo "<div class=\"right-info\" style=\"position:absolute;right:0px;\">";
																echo "<button align=\"right\" type=\"button\" id=\"$name\" class=\"btn btn-primary\" onclick=unFollowUser(\"$name\")>Followed</button>";
															echo "</div>";
														echo "</div>";
													echo "</div>";
												echo "</div>";
...
<script>
   function unFollowUser(user){
       ...
       xmlhttp.open("POST","unFollowUser.php?username="+user,true);
