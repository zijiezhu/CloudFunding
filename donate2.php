													...
													<div class="pyment-area">
														...
														<!-- <form method="POST" action="donate_process.php"> -->
															<div class="amount-area">
																...
																<div class="right-side">
																	<input type="text" name="finalamount" value="<?php echo $GLOBALS['totalm'];?>">
																</div>
															</div>
															...
															<div class="cs-holder">
															    <!-- <input  hidden name="totalm" value="<?php echo $GLOBALS['totalm'];?>"> -->
																<!-- <input hidden name="pid" value="<?php echo $GLOBALS['p_id'];?>"> -->
																<form method="POST" action="donate_process.php">
																<input hidden name="pid" value="<?php echo $GLOBALS['p_id'];?>">
																<input hidden name="totalm" value="<?php echo $GLOBALS['totalm'];?>">
