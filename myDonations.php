											...
											<div class="col-lg-12">
												<div class="profile-block">
													<ul class="scroll-nav">
															...
															<li class="active"><a href="myDonations.php"><i class="icon-money"></i>My Donations</a></li>
																...
																<div class="cs-table-holder">
																	<table>
																		...
																		<tbody>
																			...
																			$getFunds="select fund.pid as pidd,amount,fstatus,pname from fund  join project on fund.pid=project.pid where fund.loginname='".$_SESSION['loginname']."'";
																			$result=mysqli_query($connection,$getFunds);
																			$count=0;
												                            while($row = @mysqli_fetch_array($result,MYSQLI_ASSOC)){
												                            	...
												                            	echo "<tr>";
												                            	echo "<td>$count</td>";
																				echo "<td><a href='projectDetail.php?pid=".$pid."'>$pname</a></td>";
